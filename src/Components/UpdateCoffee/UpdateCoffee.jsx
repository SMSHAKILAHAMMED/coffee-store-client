...
const UpdateCoffee = () => {
    ...
    return (
        <div className="bg-[#F4F3F0] p-24 ">
            <h2 className="text-5xl font-extrabold text-center text-black  mb-5">Update Coffee : {name}</h2>
            ...
            <form onSubmit={handleUpdateCoffee}>
                ...
                <input type="submit" value="Update Coffee" className="btn btn-block text-xl bg-black text-white" />
            </form>
        </div>
    );
};
